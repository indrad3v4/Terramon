...
> **Terramon note**: Engine-specific role adapted from CCGS. Terramon uses
> **Reflex (Python)**, NOT Godot/Unity/Unreal. Apply engine-agnostic principles;
> map engine APIs to Reflex components where relevant.
