...
_STOP_WORDS: frozenset[str] = frozenset({
    ...
    # --- Russian (Cyrillic) stopwords ---
    # Curated subset of stopwords-iso/stopwords-ru (539 entries) — the most
    # frequent function words, so Russian TF-IDF vectors aren't distorted by
    # high-frequency particles. NB fallback keeps them for full evidence.
    "и", "в", "во", "не", "на", "я", "что", "с", "со", "как", "а", "то",
    "все", "она", "так", "его", "но", "да", "ты", "к", "у", "же", "вы",
    "за", "бы", "по", "только", "ее", "мне", "было", "вот", "от", "меня",
    "еще", "нет", "о", "из", "ему", "теперь", "когда", "даже", "ну", "ли",
    "если", "уже", "или", "ни", "быть", "был", "до", "вас", "опять", "уж",
